      ...
      <?php echo form_open(); ?>
        ...
        <div class="form-group">
          ...
          <?php echo form_input(array(
            ...
            'maxlength' => 255,
            'value' => set_value('title') ? set_value('title') : $category->getTitle() ,
            )); ?>
          </div>
        ...
        <div class="form-group">
          ...
          <?php echo form_textarea(array(
            ...
            'value' => set_value('description') ? set_value('description') : $category->getDescription(),
            )); ?>
          </div>
        ...
        <div class="form-group">
          ...
          <div class="row">
           ...
           <div class="col-xs-8">
            ...
            <div class="col-xs-4">
              <?php echo form_submit('submit', 'Update Category', array('class' => 'input-lg btn-block btn btn-primary btn-flat')); ?>
            </div><!-- /.col -->
          </div>
      <?php echo form_close(); ?>
      </div>
