    ...
    <div class="box-body">
      ...
      <?php if( null != validation_errors() ): ?>
        <div class="callout callout-danger">
          <h4>The following error prevented comment creation</h4>
          <ul>
            <?php echo validation_errors(); ?>
          </ul>
          <p>Comments not created</p>
        </div>
      <?php endif; ?>
        ...
        <div class="form-group">
          ...
          <div class="row">
           ...
           <div class="col-xs-8">
            ...
            <div class="col-xs-4">
              <?php echo form_submit('submit', 'Add Comment', array('class' => 'input-lg btn-block btn btn-primary btn-flat')); ?>
            </div><!-- /.col -->
          </div>
      <?php echo form_close(); ?>
      </div>
