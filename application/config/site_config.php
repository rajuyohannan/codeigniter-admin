...
$config['site_theme_color'] = 'skin-blue';
...
| 	bg-green active
*/
$config['site_palette_disabled'] = 'bg-blue disabled color-palette';
$config['site_palette_original'] = 'bg-blue color-palette';
$config['site_palette_active'] 	 = 'bg-blue active color-palette';
