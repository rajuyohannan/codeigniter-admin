...
class Groups extends \Entity\Groups implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Groups' . "\0" . 'id', '' . "\0" . 'Entity\\Groups' . "\0" . 'title', '' . "\0" . 'Entity\\Groups' . "\0" . 'description', '' . "\0" . 'Entity\\Groups' . "\0" . 'status', '' . "\0" . 'Entity\\Groups' . "\0" . 'type', '' . "\0" . 'Entity\\Groups' . "\0" . 'visibility', '' . "\0" . 'Entity\\Groups' . "\0" . 'weight', '' . "\0" . 'Entity\\Groups' . "\0" . 'createdOn', '' . "\0" . 'Entity\\Groups' . "\0" . 'updatedOn', '' . "\0" . 'Entity\\Groups' . "\0" . 'createdBy');
        }
