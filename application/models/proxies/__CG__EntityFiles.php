...
class Files extends \Entity\Files implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Files' . "\0" . 'id', '' . "\0" . 'Entity\\Files' . "\0" . 'entityId', '' . "\0" . 'Entity\\Files' . "\0" . 'entityType', '' . "\0" . 'Entity\\Files' . "\0" . 'filename', '' . "\0" . 'Entity\\Files' . "\0" . 'filepath', '' . "\0" . 'Entity\\Files' . "\0" . 'filemime', '' . "\0" . 'Entity\\Files' . "\0" . 'createdOn', '' . "\0" . 'Entity\\Files' . "\0" . 'uploadedBy');
        }
     ...
     * {@inheritDoc}
     */
    public function setUploadedBy(\Entity\Users $uploadedBy = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUploadedBy', array($uploadedBy));
    ...
    public function getUploadedBy()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUploadedBy', array());
