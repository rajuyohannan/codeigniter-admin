...
class Articles extends \Entity\Articles implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Articles' . "\0" . 'id', '' . "\0" . 'Entity\\Articles' . "\0" . 'title', '' . "\0" . 'Entity\\Articles' . "\0" . 'body', '' . "\0" . 'Entity\\Articles' . "\0" . 'status', '' . "\0" . 'Entity\\Articles' . "\0" . 'createdOn', '' . "\0" . 'Entity\\Articles' . "\0" . 'updatedOn', '' . "\0" . 'Entity\\Articles' . "\0" . 'createdBy', '' . "\0" . 'Entity\\Articles' . "\0" . 'groups');
        }
     ...
     * {@inheritDoc}
     */
    public function setGroups(\Entity\Groups $groups = NULL)
    {
