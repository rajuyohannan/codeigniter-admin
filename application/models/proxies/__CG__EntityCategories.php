...
class Categories extends \Entity\Categories implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Categories' . "\0" . 'id', '' . "\0" . 'Entity\\Categories' . "\0" . 'title', '' . "\0" . 'Entity\\Categories' . "\0" . 'description', '' . "\0" . 'Entity\\Categories' . "\0" . 'status', '' . "\0" . 'Entity\\Categories' . "\0" . 'createdBy', '' . "\0" . 'Entity\\Categories' . "\0" . 'createdOn');
        }
